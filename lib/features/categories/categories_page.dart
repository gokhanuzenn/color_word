...
class CategoriesPage extends StatelessWidget {
  ...
  static const List<CategoryItem> _allCategories = [
    ...
    CategoryItem(id: 'kiz_karakter', name: 'Kız Karakter', icon: '👧', color: Color(0xFFEC407A), imageCount: 60),
    CategoryItem(id: 'meslekler', name: 'Meslekler', icon: '👨‍⚕️', color: Color(0xFF78909C), imageCount: 47),
    CategoryItem(id: 'meyveler', name: 'Meyveler', icon: '🍎', color: Color(0xFFFF7043), imageCount: 51),
    CategoryItem(id: 'oyuncak', name: 'Oyuncaklar', icon: '🧸', color: Color(0xFFFF8A65), imageCount: 52),
    CategoryItem(id: 'robot', name: 'Robotlar', icon: '🤖', color: Color(0xFF9E9E9E), imageCount: 75),
    CategoryItem(id: 'sayilar', name: 'Sayılar', icon: '🔢', color: Color(0xFFFF9800), imageCount: 22),
    CategoryItem(id: 'sevimli_dostlar', name: 'Sevimli Dostlar', icon: '🐻', color: Color(0xFF8BC34A), imageCount: 40),
    ...
    CategoryItem(id: 'vahsi_dostlar', name: 'Vahşi Dostlar', icon: '🦁', color: Color(0xFF795548), imageCount: 49),
    ...
    CategoryItem(id: 'masal_kahramanlari', name: 'Masal Kahramanları', icon: '🧚', color: Color(0xFF7C4DFF), imageCount: 49),
    CategoryItem(id: 'spor', name: 'Spor', icon: '⚽', color: Color(0xFF43A047), imageCount: 40),
    CategoryItem(id: 'muzik_aletleri', name: 'Müzik Aletleri', icon: '🎸', color: Color(0xFFFF6F00), imageCount: 50),
    CategoryItem(id: 'manzaralar', name: 'Manzaralar', icon: '🏔️', color: Color(0xFF00897B), imageCount: 55),
